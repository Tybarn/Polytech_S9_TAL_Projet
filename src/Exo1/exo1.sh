...
echo " --------------------- EXO 1 ---------------------"
# change lima to univ
python change_POSTags.py ../../data/Exo1/pos_reference.txt.lima ../../data/Exo1/pos_reference.txt.lima.tmp ../../data/Exo1/POSTags_LIMA_PTB_Linux.txt
python change_POSTags.py ../../data/Exo1/pos_reference.txt.lima.tmp ../../data/Exo1/pos_reference.txt.univ ../../data/Exo1/POSTags_PTB_Universal_Linux.txt
...
cd ../Exo1/
python formatage_stanford.py ../../data/Exo1/pos_test.txt.pos.stanford ../../data/Exo1/POSTags_PTB_Universal_Linux.txt
